#{
--------------------- Estrategias de Aproximacion Generales -------------------------
- Forward:             (fn+1 - fn)/h;            O(h)
- Backward:            (fn   - fn-1)/h;          O(h)
- Centered:            (fn+1 - fn-1)/2.h;        O(h^2)
- Centered 2do orden:  (fn+1 - 2.fn + fn-1)/h^2; O(h^2)

-------------------------- Estrategias de Recursion --------------------------
- Explicita:        aprox = yn+1;           O(h)
- Implicita:        aprox = yn;             O(h)
- Crank-Nicholson:  aprox = (yn+1 + yn)/2;  O(h^2)
#}
