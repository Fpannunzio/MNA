#{
------------- Otronormalizacion Gram-Schmidt ---------------
- Ortonormaliza una base
  1. Sea B = {v1, v2, ...} input, Q = {q1, q1, ...} ortonormal output
  2. q1 = versor(v1)
  3. qi = versor( vi - sum_j[1, i - 1]( <vi.qj>.qj ))  (lo hacemos ortogonal a todos los q anteriores)
#}
