#{
----------------------- Fourier Trigonometrico -------------------------
- En las discontinuidades, fourier converge en (f(t-) + f(t+))/2
- S(f) = a0/2 + sum_i[1,inf](ak.cos(2.pi.k.t/T) + sum_i[1,inf](bn.sin(2.pi.k.t/T)
  1. a0 = 2/T.int[a,a+T]( f(t) )
  2. ak = 2/T.int[a,a+T]( f(t).cos(2.pi.k.t/T) )
  3. bk = 2/T.int[a,a+T]( f(t).sin(2.pi.k.t/T) )
- f par   => bk  = 0; ak != 0; Ck =  C-k; ak = 2.Ck;
- f impar => bk != 0; ak  = 0; Ck = -C-k; bk = i.2.Ck;
- Transformada de dominio discreto trigonometrico: ft(f) = sqrt(ak^2 + bk^2) con f = k.fo (fo = 1/T) 
#}
