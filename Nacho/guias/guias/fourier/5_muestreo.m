#{
----------------------- Muestreo Fourier -------------------------
- Teorema de Nyquist: f_s = 2.f_max => f_max = f_nyquist
- Frecuencias alias: sea f > f_max => f_alias = abs(f_s - f)
- Nf = #muestras contando tambien los negativos (en gral lo dividimos por 2). Conviene que sea potencia de 2.
- Resolucion frecuencia: delta_f = f_max/(Nf/2) = (f_s/2)/(N_f/2) = f_s/Nf = delta_f
- La resolucion debe ser menor a la distancia entre frecuencias para que se puedan diferenciar
- NFFT completa con ceros si NF > #muestras. Podemos usar una funcion ventana para suavizar.
- Tiempo para obtener cierta cantidad de puntos: total = Nf.delta_t; delta_t = T_s = 1/f_s; => t_total = Nf/f_s
#}
