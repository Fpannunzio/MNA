#{
----------------------- Fourier Exponencial -------------------------
- S(f) = sum_i[-inf,inf]( Ck.exp(i.2.pi.k.t/T) )
- Ck = 1/T.int[a,a+T]( f(t).exp(-i.2.pi.k.t/T) )
- Pasajes:
  1. C0 = a0/2
  2. ak = Ck + C-k
  3. bk = Ck - C-k
...
- Identidad de Parseval: 
  - Exponencial: int[a,a+T]( abs(f(t))^2 ) = T.sum_k[-inf,inf]( abs(Ck)^2)
  - Trigonometrica: int[a,a+T]( abs(f(t))^2 ) = a0^2/2 + 2.T.sum_k[1,inf]( ak^2 + bk^2 )
#}
