#{
-------------------------- Misc Matrices ----------------------------
- Matrix simetrica: A = A'
- Matrix ortogonal: A'.A = I; A' = inv(A); filas y columnas ortonormales
- Matrix semi-ortogonal: row: A.A' = I; cols: A'.A = I; Filas o columnas son ortonormales
- trace(A) = sum(li)
- det(A) = prod(li)

------------------- Producto Interno -----------------------
- Norma 1: sumo cols, tomo mayor (el max)
- Norma 2: sqrt(<x.x>)
- Norma 2: mayor valor singular
- Norma Frobenius: sqrt(trace(A'.A))

- Null(V) + Im(V) = Dim(V)
- Null(V) [comp. ort.] Im(V) 
- Proyector: P_l(v) = <v.l>.l con l versor (sino dividido <l.l>)
#}
