...
-------------------- Factoriacion PLU -----------------------
- A[m,n] = PLU
  - P de permutacion; L triangular inferior; U triangular superior
- Hacer gauss almacenando operaciones en matrices
  - Permutacion: pij = 1 donde Fj -> Fi. Inversa: transpuesta
  - Combinacion de filas: Fi = Fi + k.Fj => eij = k y la diagonal en 1. Inversa: todos los k.(-1)
  - Si queda un P antes de un E, se puede pasar permutando el k de E segun P
- Al finalizar, En...E1.P.A = U => A = P'.inv(E1)...inv(En).U = PLU
- inv(E1)...inv(En): Se mantiene la diagonal de 1 y se colapsan los k, cada uno en su lugar 
#}
