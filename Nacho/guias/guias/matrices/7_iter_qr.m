#{
-------------------- Iteracion QR -----------------------
- Encuentra todos los autovalores son de multiplicidad 1
  1. Ai = Qi.Ri (calculamos QR)
  2. Ai+1 = Ri.Qi (calculamos el proximo A dando vuelta QR)
- Condicion de corte: max(abs(li[k] - li[k - 1])) < eps
#}
